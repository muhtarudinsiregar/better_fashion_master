			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="<?php echo site_url('img/'.$detail_barang->foto.''); ?>" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="<?php echo site_url('img/'.$detail_barang->foto.''); ?>"></a>												
							</div>
							<div class="span5">
								<address>
